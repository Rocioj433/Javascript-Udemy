...
//CHARAT:Nos da el caracter que coincida con el numero que le pasemos por el argumento 
...
//ENDSWIDTH: Nos dice si el string acaba en el conjuto de carácteres o caracter que le indiquemos 
...
//INCLUDES:Nos da true o false en función si el caracter o conjunto de carácteres que le indiquemos esta incluido en 
//el texto  

// document.write(frase.includes('perro'))

//INDEXOF:Si existe el indice que le especifiquemos en el argumento nos da su posición y si no pues nos da un -1 
...
//LASTINDEXOF:Nos va a dar la ultima posicion del carácter o conjunto de carácteres que le pasemos por el argumento 
//si no existiera nos dara -1

// document.write(frase.lastIndexOf('es'))

//LENGTH:Nos va a dar la longitud de un string incluidos los espacios 
...
//REPLACE:Nos permite reemplazar una parte del string por otro pasandole por el primer argumento 
//lo que queremos cambiar y por el segundo la parte nueva 

// document.write(frase.replace('pastor Alemán','Boxer'))

//SLICE: Nos devuelve una porción de cadena, que nosotros le indiquemos entre dos números 
...
//SPLIT: Nos divide el string en substring que podemos decidir en cuantas porciones dividimos el string principal 

// document.write(frase.split(' ',10))

//STARWIDTH:Nos da true o false en función si el primer caracter empieza por la letra que pasemos 
//por el argumento y hace distinción entre mayusculas y minusculas 
...
//SUBSTRING: Nos devuelve una porción de cadena entre dos números que pasemos como argumentos 
//incluyendo el primero pero no el segundo 

// document.write(frase.substring(4,9))

//TOLOCALELOWERCASE:Convierte los carácteres en minuscula dentro del entorno local . 

// document.write(frase.toLocaleLowerCase())

//TOLOCALEUPPERCASE:Convierte los caracteres en mayuscula dentro del entorno local 
...
//TRIM:Nos limpia los espacios que haya en el string. Es muy usado en la validación de formularios 
